...
export const ru: TranslationKeys = {
    ...
    examples: '📂 Примеры',
    examplesTooltip: 'Планы развития, которые можно использовать в качестве основы для собственного плана. При импорте новые задачи будут добавлены в Базу знаний к уже существующим задачам.',
    ...
    formula: 'Формула',
    weekForecast: 'В неделях',
    monthForecast: 'В месяцах',
    yearForecast: 'В годах',
