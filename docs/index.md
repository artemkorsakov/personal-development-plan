...
2. **По тематике**:
	- Программирование | Алгоритмы | Математика | и т.д.
...
|---------------------------------|----------|------------------|------------|
| Clean Code (Martin)             | 📚 Книга | Программирование | 2025-09-01 |
| Functional Programming in Scala | 🎓 Курс  | ФП               | 2025-10-15 |

#### Экспорт данных

Экспорт Базы знаний, чтобы поделиться с сообществом.
