...
2. **Навигация к задаче**
    - Клик по любой области карточки открывает связанный Markdown-файл задачи
...
- При клике на карточку открывается связанный с ней `.md`-файл.
- Выдается **Предупреждение** при превышении количества задач в работе значения из [настройки](settings.md).
